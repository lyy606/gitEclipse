...
public class CustomerController {
	 ...
	 *  客户列表
	 */
	@RequestMapping(value = "/connection/list2.action")
	 ...
	 * 电话联系客户
	 */
	@RequestMapping("/connection/phone.action")
	@ResponseBody
	public String customerPhone(String msg) {
	    //String rows = customerService.phoneCustomer(msg);
	    //if(!rows.equals(" ")){
	        return "OK";
	    //}else{
	       // return "FAIL";
	 ...
	 * 手机联系客户
	 */
	@RequestMapping("/connection/mobile.action")
	@ResponseBody
	public String customerMobile(String msg) {
	   // String rows = customerService.mobileCustomer(msg);
	   // if(!rows.equals("")){
	        return "OK";
	  //  }else{
	  //      return "FAIL";
